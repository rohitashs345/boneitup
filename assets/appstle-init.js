(function (window, k) {
    if (!window.AppstleIncluded && (!urlIsProductPage() || 'V1' === 'V2')) {
      ...
      appstleLoadScript("https://cdn.shopify.com/s/files/1/0613/2288/7363/t/1/assets/appstle-subscription.js?v=1665413367");
      ...
      RS.Config = {
        ...
        "atcButtonSelector": ".gf_row.gf_row-gap-0",
        "moneyFormat": "{% raw %}${{amount}}{% endraw %}",
        "oneTimePurchaseText": "One Time Purchase",
        "shop": "boneitup.myshopify.com",
