...
$.ajax({
                ...
                url: '/cart/add.js',
                dataType: 'json',
                data: {id:42167298326723,quantity:1},
                success: function(){
                    location.href="/cart";
                }
            });
...
$.ajax({
                ...
                url: '/cart/add.js',
                dataType: 'json',
                data: {id:42167298359491,quantity:1},
                success: function(){
                    location.href="/cart";
                }
            });
...
(function(jQuery) {
    ...
    (function( jQuery ){
  // var $module = jQuery('#m-1681578948624').children('.module');
  ...
  // You can add custom Javascript code right here.
    ...
    (function( jQuery ){
  // var $module = jQuery('#m-1681598728408').children('.module');
  // You can add custom Javascript code right here.
})( window.GemQuery || jQuery );
